...
CResourceRadialBlurImproved::CResourceRadialBlurImproved() {
...
void CResourceRadialBlurImproved::play(float _time) {	
...
void CResourceRadialBlurImproved::init() {
...
void CResourceRadialBlurImproved::start() {
	
}

void CResourceRadialBlurImproved::deInit(void) {
	
}

string CResourceRadialBlurImproved::getType(void) {
	return "CResourceRadialBlurImproved";
}

void CResourceRadialBlurImproved::setParam(string name, string value) {
	if(name=="r") {
